...
import {
  ...
  NOTES_DEFAULT, REMINDERS_DEFAULT, MOCK_DRIVERS, MOCK_HISTORY, MOCK_HOURLY,
} from './data';
...
export function AppProvider({ children }) {
  ...
  const [drivers,     setDrivers]           = useState(MOCK_DRIVERS.map(d => ({ ...d })));
  ...
  const [operator,    setOperatorState]     = useState(() => load('operator',    'Ana Ribeiro'));
  ...
  const setOperator       = persist(setOperatorState,     'operator');
