...
export default function MonitorModals({
  ...
  return (
    <>
      {/* Template Modal */}
      {templateModal && (
        <Modal open onClose={() => setTemplateModal(null)} width={400} labelledBy="monitor-template-modal-title">
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:16 }}>
            <div>
              <div id="monitor-template-modal-title" style={{ fontSize:18, fontWeight:700, color:'var(--text-primary)' }}>
      ...
      {discardModal && (
        <Modal open onClose={() => setDiscardModal(null)} width={380} labelledBy="monitor-discard-modal-title">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
            <div>
              <div id="monitor-discard-modal-title" style={{ fontSize: 18, fontWeight: 700, color: 'var(--text-primary)' }}>
